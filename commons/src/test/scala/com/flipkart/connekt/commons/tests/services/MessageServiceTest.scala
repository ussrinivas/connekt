...
import com.flipkart.connekt.commons.iomodels.{ConnektRequest, PNRequestData, PNRequestInfo, Priority}
...
class MessageServiceTest extends CommonsBaseTest {
  ...
  val pnRequestInfo = PNRequestInfo("android", "connekt", Set[String]("bbd505411b210e38b15142bd6a0de0f6"), None, None, true,  Priority.NORMAL)
