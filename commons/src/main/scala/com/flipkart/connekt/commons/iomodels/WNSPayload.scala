...
case class WNSPayloadEnvelope(messageId: String, token: String, appName: String, deviceId: String, time_to_live: Long, contextId: String, client:String, wnsPayload: WNSPayload, meta: Map[String, Any])
