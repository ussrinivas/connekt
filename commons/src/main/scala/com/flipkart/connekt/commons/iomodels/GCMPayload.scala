...
case class GCMPayloadEnvelope(messageId: String, deviceId: Seq[String], appName: String, contextId: String, client:String, gcmPayload: GCMPayload, meta: Map[String, Any], headers: Map[String, String] = Map.empty[String, String]) extends PayloadEnvelope
