...
object LocalCacheType extends CacheType {
  val Default, UserInfo, UserGroups, ResourcePriv, UserConfiguration, WnsAccessToken, Stencils, StencilsBucket, StencilComponents, AppCredential, EngineFabrics = Value
}
