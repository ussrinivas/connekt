...
object LocalCacheType extends CacheType {
  val Default, UserInfo, UserGroups, ResourcePriv, UserConfiguration, WnsAccessToken, Stencils, StencilsBucket, StencilsEnsemble, AppCredential, EngineFabrics = Value
}
