...
object SyncType extends Enumeration {
  type SyncType = Value
  val CLIENT_ADD, TEMPLATE_CHANGE, AUTH_CHANGE, STENCIL_CHANGE, STENCIL_FABRIC_CHANGE, DISCOVERY_CHANGE,
  STENCIL_COMPONENTS_UPDATE, CLIENT_QUEUE_CREATE, SUBSCRIPTION, USER_PROJECT_CONFIG_CHANGE, EMAIL_TOPOLOGY_UPDATE,
  SMS_TOPOLOGY_UPDATE, ANDROID_TOPOLOGY_UPDATE, IOS_TOPOLOGY_UPDATE, OPENWEB_TOPOLOGY_UPDATE, WINDOW_TOPOLOGY_UPDATE = Value
}
