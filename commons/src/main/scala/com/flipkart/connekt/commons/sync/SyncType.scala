...
object SyncType extends Enumeration {
   ...
   STENCIL_COMPONENTS_UPDATE, CLIENT_QUEUE_CREATE, SUBSCRIPTION, USER_PROJECT_CONFIG_CHANGE, EMAIL_TOPOLOGY_UPDATE, SMS_TOPOLOGY_UPDATE, PUSH_TOPOLOGY_UPDATE = Value
}
