...
libraryDependencies ++= Seq(
  "com.flipkart.connekt" % "concord_2.11" % "0.2.0",
  "com.flipkart.connekt" % "connekt-concord_2.11" % "0.2.0" excludeAll ExclusionRule(organization = "com.google.guava", name = "guava"),
