          ...
          case Success(r) =>
            ...
            r.status.intValue() match {
              ...
              case 401 =>
                ...
                WindowsTokenService.refreshToken(wnsResponse._2._2)
              ...
              case w if 5 == (w/100) =>
                event = PNCallbackEvent(messageId = id, deviceId = "", platform = "android", eventType = "WNS_INTERNAL_ERROR", appName = "", contextId = "", cargo = wnsResponse._2._2, timestamp = eventTS)
