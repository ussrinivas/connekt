...
object FixedSizeBuffer {
  ...
  final class ModuloFixedSizeBuffer[T](_size: Int) extends FixedSizeBuffer[T](_size) {
  ...
  final class PowerOfTwoFixedSizeBuffer[T](_size: Int) extends FixedSizeBuffer[T](_size) {
 ...
 * INTERNAL API
 */
final class BoundedBuffer[T](val capacity: Int) extends Buffer[T] {
